...
class RasterCluster:
    ...
    def initGui(self):
        ...
        if not self.menu:
            ...
            self.action = QAction(QIcon(icon_path),"Cluster Raster", self.iface.mainWindow())
    ...
    def run(self):
        ...
        def cluster1():
            ...
            #     {'GRIDS':['/home/bisag/Documents/demo_plugins/layer Stack.tif'],
            #     'METHOD':1,
            #     'NCLUSTER':8,
            #     'MAXITER':0,
            #     'NORMALISE':False,
            #     'OLDVERSION':False,
            #     'UPDATEVIEW':True,
            #     'CLUSTER':'/home/bisag/Documents/demo_plugins/kmean.sdat',
            #     'STATISTICS':'/home/bisag/Documents/demo_plugins/static.shp'})

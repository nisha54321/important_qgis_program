...
from .mobility_corridor_dialog import MobilityCorridorDialog
import os.path
...
class MobilityCorridor:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'MobilityCorridor_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Mobility Corridor')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MobilityCorridor', message)
    ...
    def initGui(self):
        ...
        icon_path = plugin_dir+'/'+'army3.jpeg'

        #icon_path = ':/plugins/mobility_corridor/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Mobility Corridor'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = MobilityCorridorDialog()
        ...
        #buffer 
        def buffer():
            out_buffer_path = '/home/bisag/.local/share/QGIS/QGIS3/profiles/default/python/plugins/mobility_corridor/buffer.shp'
            processing.run("native:buffer", {'INPUT':'/home/bisag/.local/share/QGIS/QGIS3/profiles/default/python/plugins/mobility_corridor/linestring.shp',
        ...
        def line1():
            ...
            os.system(f"python3 /home/bisag/.local/share/QGIS/QGIS3/profiles/default/python/plugins/mobility_corridor/shortest_path.py {self.xy[-4]} {self.xy[-3]} {self.xy[-2]} {self.xy[-1]}")
            ...
            with open("/home/bisag/.local/share/QGIS/QGIS3/profiles/default/python/plugins/mobility_corridor/path.txt", 'r') as file_obj:
            ...
            error = QgsVectorFileWriter.writeAsVectorFormatV2(vl,
                                                  "/home/bisag/.local/share/QGIS/QGIS3/profiles/default/python/plugins/mobility_corridor/linestring.shp",
                                                  transform_context,
                                                  save_options)
            ...
            os.system(f"python3 /home/bisag/.local/share/QGIS/QGIS3/profiles/default/python/plugins/mobility_corridor/elevation_profile.py")
            self.dlg.pushButton_cesium.show()
            self.dlg.pushButton_path_2.show()
            self.dlg.pushButton_animation.show()
            
        def elevation_profile():
            os.system(f"eog /home/bisag/.local/share/QGIS/QGIS3/profiles/default/python/plugins/mobility_corridor/elevation_profile.png")

        def cesium():
            run_server = 'gnome-terminal --title="cesium_server" --command="bash -c \'cd /home/bisag/.local/share/QGIS/QGIS3/profiles/default/python/plugins/mobility_corridor/; python3 -m http.server 3000; $SHELL\'"'
        ...
        def animation():
            ...
            def load_and_configure(filename):
                ...
                try:
                    symbol = QgsSvgMarkerSymbolLayer('/home/bisag/Documents/acer_backup/svgimg/svg2.svg')

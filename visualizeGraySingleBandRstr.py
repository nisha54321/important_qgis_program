...
class VisualiseBand:
    ...
    def initGui(self):
        ...
        # icon_path = ':/plugins/visualise_band/icon.png'
        # self.add_action(
        #     icon_path,
        #     text=self.tr(u'single band visualize'),
        #     callback=self.run,
        ...
        if not self.menu:
            ...
            self.action = QAction(QIcon(icon_path),"Visualise Band", self.iface.mainWindow())

...
class BandRatio:
    ...
    def initGui(self):
        ...
        # icon_path = ':/plugins/band_ratio/icon.png'
        # self.add_action(
        #     icon_path,
        #     text=self.tr(u'Band Ratio'),
        #     callback=self.run,
        ...
        # self.action = QAction(QIcon(icon_path),"Band Ratio", self.iface.mainWindow())
        ...
        def resambling():
            ...
            for i in selectedBandmerge:
                ...
                if size == size1:
                    ...
                    op = plugin_dir+'/layerstack/resample/'+'Resampling_image%s.tif'%(endnametif)
                    print(res)
                    print(max1)
                    print(op)

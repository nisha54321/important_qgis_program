...
class PcaRaster:
    ...
    def initGui(self):
        ...
        if not self.menu:
            ...
            self.action = QAction(QIcon(icon_path),"pca algo", self.iface.mainWindow())
    ...
    def run(self):
        ...
        def pca(inputRasterFileName, outputRasterFileName, outPCBands):
            ...
            ob.close()
        outputRasterFileName = plugin_dir+"/layer Stack_PCAAlgo.tif"

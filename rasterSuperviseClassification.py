...
class Classification_Raster:
    ...
    def run(self):
        ...
        def display_point( pointTool ): 
            ...
            symbol = QgsMarkerSymbol.createSimple({'name': 'cross2', 'color': 'red','size':'8'})
        ...
        def roi():
            ...
            narea = str(self.dlg.lineEdit_area.text())
            print(narea)
            ...
            pr.addAttributes([QgsField("MC_ID", QVariant.String),QgsField("MC_name", QVariant.String),QgsField("C_ID", QVariant.String),QgsField("C_name", QVariant.String)])
            self.layer.updateFields() 

            Aval = [self.c,"mc_"+str(self.c),self.c,str(narea)]
            poly.setAttributes(Aval)
            ...
            save_options.fileEncoding = "UTF-8"
            transform_context = QgsProject.instance().transformContext()
            error = QgsVectorFileWriter.writeAsVectorFormatV2(self.layer,plugin_dir+"/roiPolygon.gpkg",
                                                  transform_context,
                                                  save_options)
        ...
        def classification():
            ...
            print(self.filename)
            ###saga algorithm (supervisedclassificationforgrids )

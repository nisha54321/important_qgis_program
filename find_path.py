...
from qgis.core import QgsVectorLayer,QgsProject, QgsGeometry, QgsFeature, QgsVectorLayerTemporalProperties,QgsLayerTreeLayer, QgsSingleSymbolRenderer, QgsDataSourceUri,QgsCoordinateReferenceSystem
...
class FindPath:
    ...
    def run(self):
        try:
            ...
            #calender qdateedit
            self.dlg.dateEdit.setMinimumDate(QtCore.QDate(2022, 8, 2))
            ...
            pnode.setConnection("localhost", "5432", "postgres", "postgres", "postgres")

...
class RearrangeBand:
    ...
    def initGui(self):
        ...
        # icon_path = ':/plugins/rearrange_band/icon.png'
        # self.add_action(
        #     icon_path,
        #     text=self.tr(u'multiband to single band'),
        #     callback=self.run,
        ...
        self.action = QAction(QIcon(icon_path),"Rearrange Band", self.iface.mainWindow())

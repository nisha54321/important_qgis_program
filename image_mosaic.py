...
class ImageMosaic:
    ...
    def initGui(self):
        ...
        if not self.menu:
            ...
            self.action = QAction(QIcon(icon_path),"ImageMosaic", self.iface.mainWindow())
            self.action.setObjectName( 'ImageMosaic' )
    ...
    def unload(self):
        ...
        for action in self.menu.actions():
            ...
            if action.objectName() == "ImageMosaic":
    ...
    def run(self):        
        ...
        def mosaic():
            # rlayer = QgsRasterLayer(self.filename[0], "imageMosaic")
            # key1 = str(rlayer.rasterType())
            # print(key1)

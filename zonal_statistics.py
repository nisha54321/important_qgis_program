...
class ZonalStatistics:
    ...
    def initGui(self):
        ...
        if not self.menu:
            ...
            self.action = QAction(QIcon(icon_path),"ZonalStatistics", self.iface.mainWindow())
            self.action.setObjectName( 'ZonalStatistics' )
    ...
    def unload(self):
        ...
        for action in self.menu.actions():
            ...
            if action.objectName() == "ZonalStatistics":

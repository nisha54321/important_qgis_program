...
#src_filename = r"/home/bisag/.local/share/QGIS/QGIS3/profiles/default/python/plugins/raster_path/Feature_shp11.tif"
src_filename = cwd+'/40_R_DEM1.tif'
...
results = []
labels = []
with open(cwd+'/path_points.txt') as f:
    cnt = 0

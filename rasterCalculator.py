...
class Raster_Calculator:
    ...
    def initGui(self):
        ...
        # icon_path = ':/plugins/raster_calculator/icon.png'
        # self.add_action(
        #     icon_path,
        #     text=self.tr(u'raster calculator'),
        #     callback=self.run,
        ...
        # self.action = QAction(QIcon(icon_path),"Raster Calculator", self.iface.mainWindow())
